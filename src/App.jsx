    ...
    <div className="landing-page">
      ...
      <section className="section instructor">
        ...
        <div className="instructor-card">
          <h3>GM Mackenzie Molner</h3>
          <p>
            Grandmaster Mackenzie Molner is a highly respected professional
            chess player and coach known for his elite tournament experience and
        ...
        <div className="instructor-card">
          <h3>LHS Students</h3>
          <p>
            Chess club members from the Livingston High School Chess Team, which stands as a premier national powerhouse. As four-time repeat State Champions and a consistent fixture in the national Top 10, the team recently distinguished itself as the runner-up at the 2024 High School Nationals. Beyond their accolades, these players are recognized for their deep technical proficiency and a disciplined approach to the game, cementing Livingston’s reputation as one of the most formidable scholastic programs in the United States Chess Federation circuit.
          </p>
        </div>
      </section>
      ...
      <section id="register" className="section register">
        ...
        <a
          href="https://www.jotform.com/app/251065085299160"
          target="_blank"
